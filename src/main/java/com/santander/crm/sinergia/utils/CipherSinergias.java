...
//		}
	...
	public static String cipherURL(String texto, String clave) throws Exception {
		String base64EncryptedString = "";
//		String secretKey = "rtcJupiterkey";
...
//
//			// String encriptado
//			// ="oH53qTsoiUiAVbyUqQBcoIjs4dbP%2FWffV%2BumVtXzC9SBTRe6vwUctwFERmzEQGGsD7UOxT7uJ3Y%3D";
//			// String desencriptado =
//			// CipherJupiter.desCipher(URLDecoder.decode(encriptado,"UTF-8"),CVE_NEO);
//			byte[] plainTextBytes = texto.getBytes("utf-8");
//			byte[] buf = cipher.doFinal(plainTextBytes);
//			byte[] base64Bytes = Base64.encodeBase64(buf);
//			base64EncryptedString = new String(base64Bytes);
...
//		}
	...
	public static String desCipherURL(String textoEncriptado, String clave) throws Exception {
		String base64EncryptedString = "";
//		String secretKey = "rtcJupiterkey";
//		if ((clave != null) && (!"".equals(clave))) {
//			secretKey = clave;
